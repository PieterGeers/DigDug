...
public:
	...
	static void RegisterP1Service(std::shared_ptr<GameObject>& service) { m_pPlayer1 = (service == nullptr) ? m_pDefaultGameObject : service; }
	static void RegisterP2Service(std::shared_ptr<GameObject>& service) { m_pPlayer2 = (service == nullptr) ? m_pDefaultGameObject : service; }
